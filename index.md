...
In my final milestone, I successfully installed a DFPlayer on my breadboard. This was by far the biggest challenge, since I had to read a couple of articles on what each pin on the player meant, how to wire it properly, how to apply Ohm's law with resisters, and finding the space to place it on my single breadboard. In the end, I was able to install my DFPlayer, with the limitation that my piano buttons could no longer play more than 3 sounds at a time. This is due to the tone functions associated with the DFPlayer and the buttons, but I figured it was ok because the DFPlayer can play MP3 files, which have more than 3 frequencies. I then also installed 3 blue buttons; one that adjusts the volume for the DFPlayer alone; one that changes the mp3 file in the DFPlayer; and one that shifts the frequenies of the buttons to play higher notes. I am delighted with my modifications, and my project has transformed into something I love as a pianist myself. After BSE, I hope to develop new projects with my newly gained automacy throughout the BSE experience. 
